...
$pdo = get_pdo();
$sql = "SELECT reservations.id, titre, description, debut, fin, reservations.id_utilisateur, utilisateurs.id FROM `reservations` INNER JOIN utilisateurs ON reservations.id_utilisateur = utilisateurs.id  ";
